...
describe("CategorySelect", () => {
  ...
  describe("renderowanie", () => {
    it("renderuje select z placeholder", () => {
      ...
      render(<CategorySelect categories={mockCategories} onChange={mockOnChange} />);
    ...
    it("renderuje pustą listę kategorii", () => {
      const mockOnChange = vi.fn();
      render(<CategorySelect categories={[]} onChange={mockOnChange} />);
  ...
  describe("wyświetlanie wybranej wartości", () => {
    it("wyświetla wybraną kategorię", () => {
      const mockOnChange = vi.fn();
      render(<CategorySelect value="cat-2" categories={mockCategories} onChange={mockOnChange} />);
    ...
    it("wyświetla placeholder gdy value jest undefined", () => {
      const mockOnChange = vi.fn();
      render(<CategorySelect value={undefined} categories={mockCategories} onChange={mockOnChange} />);
  ...
  describe("disabled state", () => {
    it("wyłącza select gdy disabled=true", () => {
      const mockOnChange = vi.fn();
      render(<CategorySelect categories={mockCategories} onChange={mockOnChange} disabled={true} />);
  ...
  describe("edge cases", () => {
    it("obsługuje kategorię z długą nazwą", () => {
      ...
      const mockOnChange = vi.fn();
      render(<CategorySelect categories={longNameCategories} onChange={mockOnChange} />);
    ...
    it("obsługuje kategorię ze znakami specjalnymi", () => {
      ...
      const mockOnChange = vi.fn();
      render(<CategorySelect categories={specialCategories} onChange={mockOnChange} />);

      expect(screen.getByText("Kategoria & Podkategoria (Specjalna)")).toBeInTheDocument();
    });
